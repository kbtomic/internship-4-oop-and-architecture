...
namespace DungeonCrawlerGame.Data
{
    public static class StartValues
    {
        ...
        public static int LowerBoundHP { get; set; } = 1;
        public static int UpperBoundDamage { get; set; } = 100;
        public static int LowerBoundDamage { get; set; } = 1;
        public static int ManaConsumptionForAttacking { get; set; } = 2;
        public static int ManaConsumptionForRenewingHP { get; set; } = 10;
        public static int LevelUpHP { get; set; } = 15;
        public static int LevelUpDamage { get; set; } = 5;
        public static int ProbabilityPercentage { get; set; } = 30;

        public static int LowerBoundWarriorHP { get; set; } = 90;
        public static int UpperBoundWarriorHP { get; set; } = UpperBoundHP;
        public static int LowerBoundMageHP { get; set; } = LowerBoundHP;
        ...
        public static int LowerBoundWarriorDamage { get; set; } = LowerBoundDamage;
        ...
        public static int LowerBoundGoblinHP { get; set; } = LowerBoundHP;
        ...
        public static int LowerBoundGoblinDamage { get; set; } = LowerBoundDamage;
